...
gdprCookieNoticeLocales.en = {
    description: "Używamy ciasteczek, aby oferować lepsze wrażenia z przeglądania, personalizować treści i reklamy, zapewniać funkcje mediów społecznościowych i analizować nasz ruch. Przeczytaj, w jaki sposób używamy ciasteczek i jak możesz je kontrolować, klikając Ustawienia. Wyrażasz zgodę na nasze ciasteczka, jeśli nadal korzystasz z tej witryny.",
    settings: "Ustawienia",
    accept: "Akceptuje",
    statement: "Nasza Polityka Cookies",
    save: "Zapisz Ustawienia",
    always_on: "Zawsze Włączone",
    cookie_essential_title: "Podstawowe Caisteczka",
    cookie_essential_desc: "Niezbędne pliki cookie pomagają w korzystaniu z witryny internetowej, umożliwiając podstawowe funkcje, takie jak nawigacja po stronie i dostęp do bezpiecznych obszarów witryny. Witryna nie może działać poprawnie bez tych ciasteczek.",
    cookie_performance_title: "Wydajnościowe Ciasteczka",
    cookie_performance_desc: "Te pliki cookie służą do poprawy wydajności i funkcjonalności naszych witryn internetowych, ale nie są niezbędne do ich używania. Na przykład przechowuje preferowany język lub region, w którym się znajdujesz.",
    cookie_analytics_title: "Analityczne Ciasteczka",
    cookie_analytics_desc: "Używamy analitycznych ciasteczek, aby pomóc nam zmierzyć, w jaki sposób użytkownicy wchodzą w interakcję z zawartością witryny, co pomaga nam dostosować nasze witryny i aplikacje do Ciebie, aby poprawić Twoje wrażenia.",
    cookie_marketing_title: "Marketingowe Ciasteczka",
    cookie_marketing_desc: "Te pliki cookie służą do dostosowywania komunikatów reklamowych do Ciebie i Twoich zainteresowań. Celem jest wyświetlanie reklam, które są trafne i angażujące dla indywidualnego użytkownika, a tym samym bardziej wartościowe dla wydawców i reklamodawców zewnętrznych."
};
